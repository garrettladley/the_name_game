...
func routes(app *fiber.App) {
	...
	app.Post("/game/:game_id/:player_id/post", intoSessionedHandler(handlers.PostGame, store))
	app.Get("/game/:game_id/:player_id/post", intoSessionedHandler(handlers.PostGameIndex, store))
}
